...
import { PATIENT_TYPES, MEMBER_TYPES } from "@/features/sharedConstants";

import { useBaseFilter } from "@/hooks";
import { Tabs } from "@mantine/core";

import {
  ExistingMembersRightPanel,
  ExistingMembersRoute,
} from "./existing-members";
import {
  RegisteredUsersRoute,
  RegisteredUsersRouteRightPanel,
} from "./registered-users";
import {
  AppMemberRequestsRightPanel,
  AppMemberRequestsRoute,
} from "./app-member-requests";
...
export const ChildPatientList = () => {
  ...
  return (
    <div>
      <Header title="Registered Patients (Child)">
