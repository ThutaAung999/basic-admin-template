...
import { formatDate, calculateAge, formatDateTime } from "@/features/utils";
...
export const MotherAppMemberRequest = ({
  data,
  isLoading,
}: PatientTableProps) => {
              ...
              name: (
                <div>
                  ...
                  <div className="text-gray-400">
                    YTM:{row?.patient?.patient_number}
                  </div>
                  <div className="text-gray-400">
                ...
                <div className="flex flex-row gap-5 mx-5">
                  <Tooltip label="Details">
                    <div
                      ...
                      onClick={() => {
                        navigate(
                          `/mothers/patients/detail/${row?.patient?._id}`,
                        );
                      }}
                    >
                      <FaInfoCircle />
